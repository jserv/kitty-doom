 ...
 * converting indexed 8-bit palette data to RGB24 format. It bypasses PureDOOM's
 * scalar conversion for improved performance.
 */
 ...
 * @indexed : Pointer to 8-bit indexed pixel data (typically 320x200 = 64000
 *            pixels).
 * @rgb24   : Pointer to output RGB24 buffer (typically 64000 * 3 = 192000
 *            bytes).
